...
<main>
    <div class="text-center">
        <h1 class="text-6xl pb-5">Employees</h1>
        <a href="/dashboard/employees/create"
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-3 flex">
                                    ...
                                    <form use:enhance={() => {
                                        deleting = true
                                        return () => {
                                            employees.splice(employees.findIndex(e => e.id === employee.id), 1)
                                            alertMessage = "Employee deleted successfully"
                                            deleting = false
                                        }
                                    }} action="?/deleteEmployee" method="POST">
